...
public class SyncAD implements Handler<Long> {
    ...
    public SyncAD(Vertx vertx) {
        ...
        final HttpClientOptions options = new HttpClientOptions()
				.setDefaultHost(sqoolConfig.getString("host"))
                .setDefaultPort(sqoolConfig.getInteger("port"))
                .setSsl(sqoolConfig.getBoolean("ssl", true))
                .setMaxPoolSize(sqoolConfig.getInteger("pool-size", 5))
