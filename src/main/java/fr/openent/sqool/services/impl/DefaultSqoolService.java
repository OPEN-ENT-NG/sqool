...
public class DefaultSqoolService implements SqoolService {
    ...
    @Override
    public void export(String uai, Handler<Either<String, JsonArray>> handler) {
        final String query =
                ...
                "'ELEVE' as type, COLLECT(DISTINCT se.UAI) as uai, u.externalId as userId, " +
                "COLLECT(DISTINCT c.name) as realClassesNames, u.level as level, " +
